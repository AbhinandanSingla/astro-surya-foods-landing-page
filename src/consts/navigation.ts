export const NAV_LINKS = [
  { label: "Home", href: "/" },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/048-brand",
        children: [
          { label: "XXXL Supreme", href: "/048-brand/xxxl-supreme" },
          { label: "Signature XXL", href: "/048-brand/signature-xxl" },
          { label: "Rozana", href: "/048-brand/rozana" },
          { label: "Tibar Classic", href: "/048-brand/tibar-classic" },
          { label: "Dubar Delight", href: "/048-brand/dubar-delight" },
          { label: "Mini Dubar Express", href: "/048-brand/mini-dubar-express" },
        ],
      },
    ],
  },
  {
    label: "048 Brand",
    items: [
      { label: "View Complete Range", href: "/048-brand" },
      { label: "XXXL Supreme", href: "/048-brand/xxxl-supreme" },
      { label: "Signature XXL", href: "/048-brand/signature-xxl" },
      { label: "Rozana", href: "/048-brand/rozana" },
      { label: "Tibar Classic", href: "/048-brand/tibar-classic" },
